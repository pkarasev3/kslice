...
class KSlice:
  def __init__(self, parent):
    parent.title = "KSlice" # TODO make this more human readable by adding spaces
...
""" # replace with organization, grant and thanks.
    ...
    try:
      ...
      slicer.selfTests = {}
    slicer.selfTests['KSlice'] = self.runTest
...
class KSliceWidget:
  ...
  def setup(self):
    ...
    self.reloadButton.name = "KSlice Reload"
  ...
  def onReload(self,moduleName="KSlice"):
...
class KSliceTest(unittest.TestCase):
  """
