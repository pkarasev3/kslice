...
for k = 1:K
  ...
  imwrite( img, [output_dir '/slice_' strname '.png'], 'png' );
...
setenv('mha_to_png_path',output_dir);
!ls $mha_to_png_path | grep png | grep slice > $mha_to_png_path/images.png.txt
