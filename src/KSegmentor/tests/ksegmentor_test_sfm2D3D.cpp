...
void  RunTest_Segment2D3D( vtkImageData* image, vtkImageData* label, int contour_iters = 100, double smoothness_lambda = 0.5)
{
    PrintSizes();
...
int main( int argc, char* argv[] )
{
    ...
    lblReader->SetFileName(opts.labelFilenames[idx].c_str());
        ...
        RunTest_Segment2D3D(image,label,opts.segmentor_iters,opts.smoothness_kappa); // should update label in-place
