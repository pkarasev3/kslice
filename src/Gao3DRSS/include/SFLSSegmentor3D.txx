...
::initializeSFLSFromMask()
{
  if (!mp_mask)
    {
      std::cerr<<"set mp_mask first." << endl;
      raise(SIGABRT);
    }

  IFLOG("Gao3D_TimingDebug", cout<<"Gao3D_TimingDebug: initializePhi()" << endl; )
  initializePhi();

  IFLOG("Gao3D_TimingDebug", cout<<"Gao3D_TimingDebug: initializeLabel()" << endl; )
  initializeLabel();
