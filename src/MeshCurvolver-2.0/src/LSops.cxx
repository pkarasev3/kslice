/*=========================================================================
  ...
  Module:    $HeadURL: http://svn.slicer.org/Slicer3/trunk/Applications/CLI/SparseFieldLevelSetContour/LSops.cxx $
  Language:  C++
...
vector<int> SparseFieldLS::Evolve(int its )
{
    ...
    for( int its_ = 0; its_ < its; its_++ ) {  
      ...
      std::valarray<double> F = energy->getforce( L_z, L_p1, L_n1, phi );  // update val along LZ
