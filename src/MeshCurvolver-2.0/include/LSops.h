/*=========================================================================
  ...
  Module:    $HeadURL: http://svn.slicer.org/Slicer3/trunk/Applications/CLI/SparseFieldLevelSetContour/LSops.h $
  Language:  C++
...
{
public:
  SparseFieldLS( MeshOps::MeshData* data, const std::list<int>& C, MeshEnergy* mergy )
{
    L_z = C;
    meshdata = data;
    energy = mergy;
...
SparseFieldLS( MeshOps::MeshData* data, const std::list<int>& C,
